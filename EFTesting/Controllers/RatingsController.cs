...
namespace EFTesting.Controllers
{
    public class RatingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RatingId,RatingCode,Description")] Rating rating)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RatingId,RatingCode,Description")] Rating rating)
        {
